...
wf1 = mm.WorkFlow1_dist(targetTime=PQ.PhysicalQuantity(1.,'s'))
...
wf2 = mm.WorkFlow2_dist(targetTime=PQ.PhysicalQuantity(1.,'s'))
...
#Get maximum deflection as KPI
maxDeflection2 = wf2.getProperty(PropertyID.PID_Deflection, wf2.targetTime)
